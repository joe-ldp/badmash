...
getMCatalogCellURL = (id, track, column) => {
    return `https://docs.google.com/spreadsheets/d/${process.env.SHEET_KEY}/edit#gid=${this.sheet.sheetId}&range=${column}${getRows().findIndex(r => r.ID == id && r.Track == track) + 2}`;
}
